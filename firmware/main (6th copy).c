...
void VO_Iterate(voice_t *vo){
	...
	static volatile uint16_t w0 = INCREMENT_FROM_FREQ(220) ;
	static volatile uint16_t w1 = INCREMENT_FROM_FREQ(440) ;
	...
	s = (SQUARE(p0 >> 8) + SIN(p1 >> 8)) / 2;
	OCR0A = s + 128; // has to be 128
